...
function Carta() {
	//Propiedades
    this.indice = Math.floor(Math.random() * 52) + 1; //Se genera aleatoriamente el 
    //indice de la carta  , con floor saco la parte entera (numeros hasta 51) 
    //con el  +1 hago que los numeros sean hasta 52
